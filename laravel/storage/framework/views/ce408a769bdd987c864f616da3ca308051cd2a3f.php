<?php $__env->startSection('title', 'Logbook Loan Applications'); ?>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="filter-form" class="form-inline form-horizontal" action="<?php echo e('/ajax/auto/applications/'); ?>" method="GET">
                            <?php echo csrf_field(); ?>
                        ...
                        <div class="material-datatables">
                            <table id="applications-dt" data-source="<?php echo e(url('ajax/auto/applications/'.$status)); ?>" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Applicant</th>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/trevor/Desktop/Beyond/quicksavabackend/laravel/resources/views/auto/applications.blade.php ENDPATH**/ ?>