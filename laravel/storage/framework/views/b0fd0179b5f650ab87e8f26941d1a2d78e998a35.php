    ...
    <div class="container">
        <div class="navbar-wrapper">
            <a class="navbar-brand" href="<?php echo e(url('login')); ?>">
                <img src="<?php echo e(url('assets/img/logo.png')); ?>" width="200">
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse justify-content-end">
            <ul class="navbar-nav">
                ...
                <li class="nav-item  active ">
                    <a href="<?php echo e(url('login')); ?>" class="nav-link">
...
<div class="wrapper wrapper-full-page">
    <div class="page-header login-page header-filter" filter-color="black"
         style="background-image: url('<?php echo e(url('assets/img/bg.jpg')); ?>'); background-size: cover; background-position: top center;">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 ml-auto mr-auto">
                ...
                <form class="form" method="POST" action="<?php echo e(route('login')); ?>">
                    ...
                    <div class="card card-login card-hidden">
                        ...
                        <div class="card-body ">
                            <p class="card-description text-center">Enter your E-mail and password</p>
        ...
        <footer class="footer">
            <div class="container">
                ...
                <div class="copyright float-right">
                    ...
                    <a href="https://berxley.com" target="_blank">Berxley.</a> Persistent Innovation.
                </div>
            </div>
        </footer>
    </div>
...
<?php /**PATH /home/trevor/Desktop/Beyond/quicksavabackend/laravel/resources/views/auth/login.blade.php ENDPATH**/ ?>