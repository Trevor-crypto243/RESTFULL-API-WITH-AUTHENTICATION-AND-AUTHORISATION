...
<?php $__env->startPush('css'); ?>
    <link type="text/css" rel="stylesheet" href="<?php echo e(url('waitMe/waitMe.css')); ?>">
<?php $__env->stopPush(); ?>
<?php $__env->startPush('js'); ?>
    <script src="<?php echo e(url('waitMe/waitMe.js')); ?>"></script>
    ...
    <script>
        ...
        function getTotalCustomers() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo url('/dashboard/get_total_customers/'); ?>",
        ...
        function getCheckoffCustomers() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo url('/dashboard/get_checkoff_customers/'); ?>",
                data: {"_token": "<?php echo e(csrf_token()); ?>"},
                //timeout: 5000,
                success: function (resp) {
                    console.log(resp);
        ...
        function getApproveToday() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo url('/dashboard/get_approved_today/'); ?>",
                data: {"_token": "<?php echo e(csrf_token()); ?>"},
                //timeout: 5000,
                success: function (resp) {
                    console.log(resp);
        ...
        function getPaidToday() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo url('/dashboard/get_paid_today/'); ?>",
                data: {"_token": "<?php echo e(csrf_token()); ?>"},
                //timeout: 5000,
                success: function (resp) {
                    console.log(resp);
        ...
        function getTotalDisbursed() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo url('/dashboard/get_total_disbursed/'); ?>",
                data: {"_token": "<?php echo e(csrf_token()); ?>"},
                //timeout: 5000,
                success: function (resp) {
                    console.log(resp);
        ...
        function getTotalRepaid() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo url('/dashboard/get_total_repaid/'); ?>",
                data: {"_token": "<?php echo e(csrf_token()); ?>"},
                //timeout: 5000,
                success: function (resp) {
                    console.log(resp);
        ...
        function getDueToday() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo url('/dashboard/get_due_today/'); ?>",
                data: {"_token": "<?php echo e(csrf_token()); ?>"},
                //timeout: 5000,
                success: function (resp) {
                    console.log(resp);
        ...
        function getOverdue() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo url('/dashboard/get_overdue/'); ?>",
                data: {"_token": "<?php echo e(csrf_token()); ?>"},
                //timeout: 5000,
                success: function (resp) {
                    console.log(resp);
        ...
        function getWalletsAmount() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo url('/dashboard/get_wallets_amount/'); ?>",
                data: {"_token": "<?php echo e(csrf_token()); ?>"},
                //timeout: 5000,
                success: function (resp) {
                    console.log(resp);
        ...
        function getTotalWalletsWithdrawal() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo url('/dashboard/get_total_wallet_withdrawals/'); ?>",
                data: {"_token": "<?php echo e(csrf_token()); ?>"},
                //timeout: 5000,
                success: function (resp) {
                    console.log(resp);
        ...
        function getTodaysWalletsWithdrawals() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo url('/dashboard/get_todays_wallet_withdrawals/'); ?>",
                data: {"_token": "<?php echo e(csrf_token()); ?>"},
                //timeout: 5000,
                success: function (resp) {
                    console.log(resp);
    ...
    <script>
        function drawChart() {
            ...
            data.addRows([
                ...
                ['<?php echo e($date->format('jS')); ?>', <?php echo e(App\LoanRequest::whereDate('created_at', Carbon\Carbon::createFromDate($date))->sum('amount_requested')); ?>, <?php echo e(App\LoanRepayment::whereDate('created_at', Carbon\Carbon::createFromDate($date))->sum('amount_repaid')); ?>],
                <?php endforeach; ?>
            ]);
...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12">
            <?php echo $__env->make('layouts.common.success', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php echo $__env->make('layouts.common.warnings', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php echo $__env->make('layouts.common.warning', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6" style="padding-right: 0px">
            <a href="<?php echo e(url('customers/checkoff/summary')); ?>">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6" style="padding-right: 0px">
            <a href="<?php echo e(url('/loans/approved_today')); ?>">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6" style="padding-right: 0px">
            <a href="<?php echo e(url('loans/repaid/today')); ?>">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6" style="padding-right: 0px">
            <a href="<?php echo e(url('loans/repaid')); ?>">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6" style="padding-right: 0px">
            <a href="<?php echo e(url('loans/due_today')); ?>">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6" style="padding-right: 0px">
            <a href="<?php echo e(url('loans/overdue')); ?>">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6" style="padding-right: 0px">
            <a href="<?php echo e(url('wallets/transactions/all')); ?>">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6" style="padding-right: 0px">
            <a href="<?php echo e(url('wallets/transactions/today')); ?>">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <a href="<?php echo e(url('loans/overdue')); ?>" class="btn btn-primary btn-sm">
                        ...
                        <div class="col-md-6">
                            <div class="table-responsive table-sales">
                                <table class="table border">
                                    ...
                                    <?php $__currentLoopData = $overdueLoans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $overdue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <?php echo e($key); ?>
                                            ...
                                            <td>
                                                KES <?php echo e(number_format($overdue)); ?>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12" >
                                <div class="card card-stats"  style="margin-bottom: 20px">
                                    <div class="card-header card-header-primary card-header-icon">
                                        ...
                                        <h3 class="card-title" id="b2cUtility"><?php echo e(number_format(optional(\App\PaybillBalance::where('shortcode','3028315')->first())->utility, 2)); ?></h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="card card-stats" style="margin-bottom: 20px">
                                    <div class="card-header card-header-warning card-header-icon">
                                        ...
                                        <h3 class="card-title" id="b2cMmf"><?php echo e(number_format(optional(\App\PaybillBalance::where('shortcode','3028315')->first())->mmf, 2)); ?></h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="card card-stats" style="margin-bottom: 20px">
                                    <div class="card-header card-header-info card-header-icon">
                                        ...
                                        <h3 class="card-title" id="b2cMmf"><?php echo e(number_format(\App\MpesaPayment::sum('amount'), 2)); ?></h3>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="table-responsive table-sales">
                                <table class="table">
                                    ...
                                    <?php $__currentLoopData = $topPersonal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $personal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                KES <?php echo e(number_format($personal->total)); ?>

                                            </td>

                                            <td>
                                                <?php echo $personal->active == 1 ?
                                            ...
                                            <td class="text-right">
                                                <a href="<?php echo e(url('wallet/customer' ,  $personal->id)); ?>"
                        ...
                        <div class="col-md-12">
                            <div class="table-responsive table-sales">
                                <table class="table">
                                    ...
                                    <?php $__currentLoopData = $topPersonalFrozen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $personal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <?php echo e($personal->name); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/trevor/Desktop/Beyond/quicksavabackend/laravel/resources/views/admin_dashboard.blade.php ENDPATH**/ ?>