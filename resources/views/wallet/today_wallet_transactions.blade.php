@extends('layouts.app')
@section('title', 'Wallet transactions - Today')
@push('js')
    <script>
        ...
        var disburseDt = $('#transactions-dt').DataTable({
            ...
            ajax: '{{ route('today-transactions-dt') }}', // the route to be called via ajax
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-primary card-header-icon">
                        ...
                        <h4 class="card-title">Wallet transactions <small>Today</small></h4>
                    </div>
                    <div class="card-body">

                        <div class="toolbar">
                            <a href="{{url('wallets/transactions/today/export')}}" class="btn btn-success btn-sm">
