...
{{--            <a class="navbar-brand" href="#">Register on HapoKash</a>--}}
{{--        </div>--}}
...
{{--    <div class="page-header register-page header-filter" filter-color="black" style="background-image: url('{{url('assets/img/bodawerk.jpg')}}')">--}}
{{--        <div class="container">--}}
{{--            <div class="row">--}}
...
{{--                                            <h4 class="info-title">Instant Disbursements</h4>--}}
{{--                                            <p class="description">--}}
...
{{--                                        </div>--}}
{{--                                        <div class="description">--}}
{{--                                            <h4 class="info-title">Easy Beneficiary Management</h4>--}}
{{--                                            <p class="description">--}}
{{--                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt--}}
{{--                                            </p>--}}
{{--                                        </div>--}}
...
{{--                                        </div>--}}
{{--                                        <div class="description">--}}
{{--                                            <h4 class="info-title">Real Time Dashboard</h4>--}}
{{--                                            <p class="description">--}}
{{--                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt--}}
{{--                                            </p>--}}
{{--                                        </div>--}}
...
{{--                                        --}}{{--                                        </button>--}}
{{--                                        <h4 class="mt-3"> A few details to get you started </h4>--}}
{{--                                    </div>--}}
...
{{--                    <a href="https://Quicksavacredit.africa" target="_blank">Quicksava  </a> WALLET.MIND.SPIRIT.--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </footer>--}}
{{--    </div>--}}
