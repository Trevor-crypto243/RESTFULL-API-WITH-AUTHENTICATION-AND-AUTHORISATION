...
<div class="wrapper wrapper-full-page">
    <div class="page-header login-page header-filter" filter-color="black"
         style="background-image: url('{{url('assets/img/bg.jpg')}}'); background-size: cover; background-position: top center;">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 ml-auto mr-auto">
                ...
                <form class="form" method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="card card-login card-hidden">
                        ...
                        <div class="card-body ">
                            <p class="card-description text-center">Create new password</p>
        ...
        <footer class="footer">
            <div class="container">
                ...
                <div class="copyright float-right">
                    ...
                    <a href="http://Quicksavacredit.africa" target="_blank">Quicksava</a> WALLET.MIND.SPIRIT.
                </div>
            </div>
        </footer>
    </div>
