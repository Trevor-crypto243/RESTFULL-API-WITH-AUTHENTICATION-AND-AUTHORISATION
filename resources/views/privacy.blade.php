...
<html lang="en">
<head>
    <title>Privacy Policy for Quicksava Credit</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="robots" content="noindex"/>
    <meta property="og:title" content="Privacy Policy for Quicksava Credit"/>
    <meta property="og:image:width" content="1280"/>
    <meta property="og:image:height" content="720"/>
    <meta property="og:url" content="https://inua.Quicksavacredit.africa/privacy"/>
    <meta property="og:site_name" content="Quicksava Credit LTD"/>
...
<div class="page">
    <div class="header">
        <div class="container">
            <p class="title">Privacy Policy for Quicksava Credit</p>
        </div>
    </div>
    <div class="translations-content-container">
        <div class="container">
            <div class="tab-content translations-content-item en visible" id="en">
                ...
                <h1>Privacy Policy and Consumer Protection</h1>
                <p>Last updated: September 23, 2022</p>
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Application</strong> means the software program provided by the Company downloaded by
                            You on any electronic device, named Quicksava Credit</p>
                    </li>
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Quicksava Credit, Head office:
                            SAMEER PARK BLOCK E-1 FIRST FLOOR.</p>
                    </li>
                    <li>
                ...
                <h3>Data We Collect And Reason For Collecting It</h3>
                <p>
                    With users’ explicit permission, Quicksava collects key pieces of data from its users’ devices solely
                    for the purposes of underwriting loan applicants who typically have little or no documented
                    financial history. The data that we analyze includes but is not limited to merchant transactions,
                    app usage, texts and calls, and personal identifiers. We select these data sources for the purposes
                    of understanding a user’s potential financial capacity, his or her behavioral attributes, and to
                    validate his or her identity. We only collect data that we need and will continually evaluate the
                    necessity of collected data classes for such consideration.
                </p>
                <p>
                    We determine the weights of individual data points using state-of-the-art machine learning
                    techniques, trained on historic user data. Once a customer has taken a loan with us, his/her
                    repayment behavior is used as the most important factor for future lending decisions.
                </p>

                <h3>
                    How Do Users Elect To Share Their Data With Quicksava?
                </h3>
                <p>
                    Quicksava explicitly requests permissions from users to share their data. Every permission is
                    individually granted using a standardized dialogue under the Terms and Conditions. Quicksava includes
                    clear additional explanations of what data we are requesting and how it will be used going forward.
                </p>

                <h3>
                    Does Quicksava Share User Data With Third Parties?
                </h3>

                <p>
                    Other than required by local law or in the ordinary course of our business and to provide loan
                    products (such as to report to a national credit bureau), Quicksava does not share personally
                    identifiable information about any individual with any third parties.
                </p>

                <h3>
                    How Does Quicksava Protect User Data?
                </h3>

                <p>
                    Quicksava the Application, will have access to the customer’s precise location (GPS and networkbased),
                    text messages (SMS or MMS, phone status and identity, device ID & call information. Other
                ...
                <p>
                    All user data is maintained in databases that are secured by industry standard security techniques.
                    Access to personally-identifiable information is limited to only those team members that require it
                    for their job. Data is fully encrypted while in transit.

                </p>


                <h3>
                    How Does Quicksava Avoid Discriminatory Practices And Algorithmic Bias?
                </h3>

                <p>
                    Quicksava is committed to fair lending practices that do not discriminate based on gender, race,
                    ethnicity, religion, national origin, or sexual orientation. We seek to follow guidelines that
                    ensure that we do not build any features based on these data points and consider and mitigate if
                    possible the implicit algorithmic bias that might arise with regards to these categories.
                ...
                <ul>
                    <li>
                        <p>By email: info@Quicksavacredit.africa</p>
                    </li>
                    <li>
                        <p>By visiting this page on our website: <a href="https://Quicksavacredit.africa/"
                                                                    rel="external nofollow noopener" target="_blank">https://Quicksavacredit.africa/</a>
                        </p>
                    </li>
                    <li>
                        <p>By phone number: +254114496184 / +254741782186 /+254798889532</p>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="footer">
        <div class="container">
            <p>Copyright &copy; <a href="https://Quicksavacredit.africa/" target="_blank">Quicksava Credit LTD</a></p>
        </div>
    </div>
</div>
